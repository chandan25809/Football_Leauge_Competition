...
import 'package:Football_Competition/Screens/TableScreen.dart';
import 'package:Football_Competition/Widgets/LeagueContainer.dart';
      ...
      body:SafeArea(
        ...
        child:Container(
          decoration:BoxDecoration(
            gradient: LinearGradient(colors: [ const Color(0xffec9f05),Color(0xffff4e00)],
